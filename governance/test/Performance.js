...
const VOTING_DEPLOYMENT_COST = 2547910;
const DEFINE_FIRST_PROPOSAL_COST = 343342;
const DEFINE_SECOND_PROPOSAL_COST = 208350;
const DEFINE_MIN_PROPOSAL_COST = 148668;
const FIRST_VOTE_COST = 351666;
const SECOND_VOTE_COST = 161142;
const VOTE_ON_BEHALF_COST = 216313;
const EXECUTE_ONE_COST = 79527;
const EXECUTE_ALL_COST = 476717;
const ARCHIVE_SESSION_COST = 257672;
const DEFINE_PROPOSAL_WITH_ARCHIVING_COST = 253682;

...
const VOTING_DELEGATE_DEPLOYMENT_COST = 7117982;
const VOTING_DEPLOYMENT_COST = 3716463;
const DEFINE_FIRST_PROPOSAL_COST = 371895;
const DEFINE_SECOND_PROPOSAL_COST = 221696;
const DEFINE_MIN_PROPOSAL_COST = 161290;
const FIRST_VOTE_COST = 363297;
const SECOND_VOTE_COST = 172114;
const VOTE_ON_BEHALF_COST = 232975;
const EXECUTE_ONE_COST = 85054;
const EXECUTE_ALL_COST = 504784;
const ARCHIVE_SESSION_COST = 304020;
const DEFINE_PROPOSAL_WITH_ARCHIVING_COST = 300263;

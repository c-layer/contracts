...
const VOTING_DELEGATE_DEPLOYMENT_COST = 4215604;
const VOTING_DEPLOYMENT_COST = 2505278;
const DEFINE_FIRST_PROPOSAL_COST = 343348;
const DEFINE_SECOND_PROPOSAL_COST = 208328;
const DEFINE_MIN_PROPOSAL_COST = 148645;
const FIRST_VOTE_COST = 351657;
const SECOND_VOTE_COST = 161133;
const VOTE_ON_BEHALF_COST = 216246;
const EXECUTE_ONE_COST = 79571;
const EXECUTE_ALL_COST = 476762;
const ARCHIVE_SESSION_COST = 257696;
const DEFINE_PROPOSAL_WITH_ARCHIVING_COST = 253679;

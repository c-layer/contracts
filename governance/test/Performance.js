...
const VOTING_DELEGATE_DEPLOYMENT_COST = 4472967;
const VOTING_DEPLOYMENT_COST = 2487147;
const DEFINE_FIRST_PROPOSAL_COST = 371291;
const DEFINE_SECOND_PROPOSAL_COST = 231784;
const DEFINE_MIN_PROPOSAL_COST = 169215;
const FIRST_VOTE_COST = 386734;
const SECOND_VOTE_COST = 168733;
const VOTE_ON_BEHALF_COST = 234857;
const EXECUTE_ONE_COST = 91500;
const EXECUTE_ALL_COST = 447672;
const ARCHIVE_SESSION_COST = 412141;
const DEFINE_PROPOSAL_WITH_ARCHIVING_COST = 308639;

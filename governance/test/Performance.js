...
const VOTING_DELEGATE_DEPLOYMENT_COST = 4590983;
const VOTING_DEPLOYMENT_COST = 2403021;
const DEFINE_FIRST_PROPOSAL_COST = 349991;
const DEFINE_SECOND_PROPOSAL_COST = 212846;
const DEFINE_MIN_PROPOSAL_COST = 152474;
const FIRST_VOTE_COST = 354881;
const SECOND_VOTE_COST = 164404;
const VOTE_ON_BEHALF_COST = 221270;
const EXECUTE_ONE_COST = 80609;
const EXECUTE_ALL_COST = 481174;
const ARCHIVE_SESSION_COST = 259389;

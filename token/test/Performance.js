...
const CORE_GAS_COST = 4428782;
const MINTABLE_DELEGATE_GAS_COST = 1769211;
const KYCONLY_DELEGATE_GAS_COST = 2616320;
const DELEGATE_GAS_COST = 3092656;
...
const KYCONLY_FIRST_TRANSFER_COST = 81113;
const KYCONLY_FIRST_TRANSFER_FROM_COST = 92971;
const KYCONLY_TRANSFER_COST = 65633;
const FIRST_TRANSFER_COST = 104779;
const FIRST_TRANSFER_FROM_COST = 116636;
const TRANSFER_COST = 69485;
const ISSUANCE_AUDITED_FIRST_TRANSFER_COST = 169970;
const ISSUANCE_AUDITED_FIRST_TRANSFER_FROM_COST = 181829;
const ISSUANCE_AUDITED_TRANSFER_COST = 102040;
const ISSUANCE_AUDITED_FIRST_TRANSFER_AFTER_COST = 103917;
const ISSUANCE_AUDITED_TRANSFER_AFTER_COST = 68622;
const AUDITED_FIRST_TRANSFER_COST = 104779;
const AUDITED_FIRST_TRANSFER_FROM_COST = 116636;
const AUDITED_TRANSFER_COST = 69485;
const AUDITED_FIRST_TRANSFER_AFTER_COST = 104779;
const AUDITED_TRANSFER_AFTER_COST = 69485;

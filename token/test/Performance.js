...
const KYCONLY_DELEGATE_GAS_COST = 2796323;
const DELEGATE_GAS_COST = 3175033;
const PROXY_GAS_COST = 839650;

const MINTABLE_FIRST_TRANSFER_COST = 64459;
const MINTABLE_FIRST_TRANSFER_FROM_COST = 76342;
const MINTABLE_TRANSFER_COST = 48980;
const KYCONLY_FIRST_TRANSFER_COST = 80323;
const KYCONLY_FIRST_TRANSFER_FROM_COST = 92182;
const KYCONLY_TRANSFER_COST = 64843;
const FIRST_TRANSFER_COST = 105565;
const FIRST_TRANSFER_FROM_COST = 117422;
const TRANSFER_COST = 70271;
const ISSUANCE_AUDITED_FIRST_TRANSFER_COST = 169611;
const ISSUANCE_AUDITED_FIRST_TRANSFER_FROM_COST = 181470;
const ISSUANCE_AUDITED_TRANSFER_COST = 97346;
const ISSUANCE_AUDITED_FIRST_TRANSFER_AFTER_COST = 105565;
const ISSUANCE_AUDITED_TRANSFER_AFTER_COST = 70271;
const AUDITED_FIRST_TRANSFER_COST = 103570;
const AUDITED_FIRST_TRANSFER_FROM_COST = 115426;
const AUDITED_TRANSFER_COST = 68275;
const AUDITED_FIRST_TRANSFER_AFTER_COST = 226968;
const AUDITED_TRANSFER_AFTER_COST = 117733;

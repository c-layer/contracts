...
contract PublicMultiSigWithRBAC is PublicMultiSig {
  ...
  function suggest(
    ...
    uint256 _value,
    bytes memory _data) public onlySuggester returns (bool)
  {
  ...
  function addManyParticipants(
    address[] memory _participants,
    uint256[] memory _weights) public onlyOwner returns (bool)
  {
  ...
  function addManyParticipantsWithRoles(
    ...
    bool[] memory _suggesters,
    bool[] memory _approvers,
    bool[] memory _executers) public onlyOwner returns (bool)
  {
